...
至少满足以下条件：正式包已签名和公证；社群同步、多设备、费用和自动更新均通过；5–10 人连续试运行 14 天无 P0/P1；每人的官方 OpenToken 当天仍能正常上生财榜。之后先在 TokenStep 设置中关闭开机启动并退出，再把 `TokenStep.app` 移到废纸篓；灰度期保留其 App Support 数据，方便回滚。
