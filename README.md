...
> `2149a0bfb8dc00d7afe773c00a7e23b8842dd0d1`。已经在使用旧 beta.8 固定提交
> `6cd21ef5138f00fe1182b5da3ad0a9fdf3fdcc00` 的成员，现有安装、同步、榜单和历史数据无需更新；
> 只有需要在客户端自助生成第二台设备码时，才建议升级到上述新提交。
...
- 已连接成员可在现有 Mac 客户端或 Windows 命令中，自助为同一成员的另一台设备生成 60 分钟单次码；请求只使用现有设备签名，不接受昵称或成员 ID，每名成员每小时最多 3 次。
